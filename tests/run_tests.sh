...
# test empty input
# Note: convertdav treats 0-byte PUTs as "create placeholder" and skips processing
# to support Windows Explorer behavior. We won't test empty json file conversion
# through integration tests for now.
